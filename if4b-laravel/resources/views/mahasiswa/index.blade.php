                        ...
                        <form action="" method="GET">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" name="search"
                                    placeholder="Cari Mahasiswa (NPM, Nama, Kota Lahir, Program Studi)">
                        ...
                        <table class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Created At</th>
                                    <th>
                                        <form id="delete-form" action="{{ route('mahasiswa.destroy', ':id') }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                    ...
                    ">Hapus</button>
                            ...
                            <tbody>
                                ...
                                @foreach ($datamahasiswas as $item)
                                    <tr>
                                        <td>{{ $item->npm }}</td>
                                        <td><img src="{{ asset('images/mahasiswa/' . $item->foto) }}" alt="Foto"
                                                class="img-fluid"></td>
                        ...
                        <div class="mt-4" style="display: flex; justify-content:center;">
                            {{ $datamahasiswas->withQueryString()->links() }}</div>
                    </div>
                </div>
            </div>
        </div>
